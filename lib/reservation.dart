...
class Reservation extends StatefulWidget{
  final eventDatas;
  Reservation(this.eventDatas);



  @override
  State<StatefulWidget> createState() =>_Reservation(this.eventDatas);

}

class _Reservation extends State<Reservation> {
  final eData;
  _Reservation(this.eData);
                ...
                child: GNav(
                  ...
                  tabs: [
                    GButton(
                      onPressed: (){
                        Navigator.pushReplacement(
                            context, MaterialPageRoute(builder: (context) => HomePage(eData)));
                      },
                      icon: Icons.home,
                      text: "Home",
                    ...
                    GButton(
                      onPressed: (){
                        Navigator.pushReplacement(
                            context, MaterialPageRoute(builder: (context) => Events(eData)));
                      },
                      icon: Icons.speaker,
                      text: "Events",
                      backgroundGradient: LinearGradient(colors: [
                    ...
                    GButton(
                      onPressed: (){
                        Navigator.pushReplacement(
                            context, MaterialPageRoute(builder: (context) => Reservation(eData)));
                      },
                 ...
                 height:isSearchBar?800:250,
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          AnimatedContainer(
                                                              ...
                                                              width: isAnimate? screenWidth*0.293:screenWidth*0.25,
                      ...
                      !isSearchBar? AnimatedScale(
                        ...
                        child: Container(
                          ...
                          width: screenWidth,
                          height: screenWidth*1.002,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Homepage Middle----->>>>Premium Locations---->>>>Headline
                              ...
                              Container(
                                ...
                                margin:
                                EdgeInsets.only(top: 8, left: screenWidth * 0.053),
                              ...
                              Container(
                                ...
                                EdgeInsets.only(top: 8, left: screenWidth * 0.053),
                                child: const Text(
                                  "29 Premium Locations around you.",
                                  style: TextStyle(
                                    fontFamily: "Urbanist",
                                    fontWeight: FontWeight.w700,
                                    color: Color(0xff686868),
                              ...
                              // Homepage Middle----->>>>Premium Locations---->>>>Slider
                              Container(
                                width: screenWidth,
                                height: screenWidth*0.762,
                                margin:
                      ...
                      !isSearchBar?AnimatedScale(
                        ...
                        child: Container(
                          width: screenWidth,
                          height: 142,
                          margin: EdgeInsets.only(top: 0, left: screenWidth * 0.053),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AnimatedContainer(
                                duration: const Duration(milliseconds: 400),
                                width: reserveIndex > 0
                                    ? screenWidth * 0.4 * reserveIndex.toDouble()
                                    : screenWidth * 0.25,
                                height: 4,
                                margin: EdgeInsets.only(left: screenWidth * 0.064),
                                decoration: BoxDecoration(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AnimatedContainer(
                                duration: const Duration(milliseconds: 400),
                                width: guestIndex > 0
                                    ? screenWidth * 0.4 * guestIndex.toDouble()
                                    : screenWidth * 0.25,
                                height: 4,
                                margin: EdgeInsets.only(left: screenWidth * 0.064),
                                decoration: BoxDecoration(
